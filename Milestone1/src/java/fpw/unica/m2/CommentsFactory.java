...
public class CommentsFactory {
    ...
    CommentsFactory(){
        ...
        c1.setCommento("ciao bello come va vita io offro oldi");
        c1.setIdCommento(0);
        ...
        c2.setCommento("ciao bello come va vita io offro oldi");
        c2.setIdCommento(1);
        ...
        c3.setCommento("ciao bello come va vita io offro oldi");
        c3.setIdCommento(2);
        c3.setIdNotizia(0); 
        ...
        c4.setCommento("ciao bello come va vita io offro oldi");
        c4.setIdCommento(3);
        c4.setIdNotizia(1); 
        ...
        c5.setCommento("ciao bello come va vita io offro oldi");
        c5.setIdCommento(1);
        c5.setIdNotizia(1);
