...
public class NotizieFactory {
    ...
    private NotizieFactory(){
        ...
        n1.setId(0);
        n1.setCategoria(CategoriesFactory.getIstance().getCategoryByID(5));
        ...
        n2.setId(1);
        n2.setCategoria(CategoriesFactory.getIstance().getCategoryByID(2));
        ...
        n3.setId(2);
        n3.setCategoria(CategoriesFactory.getIstance().getCategoryByID(1));
    ...
    public ArrayList<Notizia> getNewsByAuthor(Utenti author)
    {
      ...
      public ArrayList<Notizia> getNewsByCat(String cat)
    {
        ArrayList<Notizia> listToReturn = new ArrayList<>();
        
        for (Notizia news : listaNotizie)
            if (news.getCategoria().equals(cat))
                listToReturn.add(news);
