...
<header id="header"> 
    ...
    <a id="search_button" onClick="showSearch()" ><img id="search_image" src="res/site_resources/search_icon.png" alt="Cerca"/></a>
     
    <input id="querybox" oname="query" type="text" placeholder="Cerca nel sito...">
    <!--Logo-->
